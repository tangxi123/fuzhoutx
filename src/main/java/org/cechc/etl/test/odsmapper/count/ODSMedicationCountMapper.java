...
@Repository
@Mapper
public interface ODSMedicationCountMapper {
    ...
    @Select(beginScriptStatement +
            ...
            endIfStatement +
            endScriptStatement)
    List<String> getOutpMedCount(Parameter parameter);
    ...
    @Select(beginScriptStatement +
            ...
            "group by record_id"+
            endScriptStatement)
    List<HashMap<String,Object>> getOutpMedProCount(Parameter parameter);
    ...
    @Select(beginScriptStatement +
            ...
            "group by record_id"+
            endScriptStatement)
    List<HashMap<String,Object>> getOutpMedLocCount(Parameter parameter);
    ...
    @Select(beginScriptStatement +
            ...
            endIfStatement +
            endScriptStatement)
    List<String> getInpMedCount(Parameter parameter);
    ...
    @Select(beginScriptStatement +
            ...
            "group by record_id"+
            endScriptStatement)
    List<HashMap<String,Object>> getInpMedProCount(Parameter parameter);
    ...
    @Select(beginScriptStatement +
            ...
            "group by record_id"+
            endScriptStatement)
    List<HashMap<String,Object>> getInpMedLocCount(Parameter parameter);
}
